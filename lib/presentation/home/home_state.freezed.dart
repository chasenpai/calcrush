...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({this.level, this.operator});
  ...
  @override
  String toString() {
    return 'HomeState(level: $level, operator: $operator)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final int? level, final int? operator}) =
      _$HomeStateImpl;
